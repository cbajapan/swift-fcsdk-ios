...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "FCSDKiOS", url: "https://swift-sdk.s3.us-east-2.amazonaws.com/client_sdk/FCSDKiOS-4.0.2.xcframework.zip", checksum: "3f9e9cdd419c78386e651274b9c9d8265757566d4682a40f42549164f15ed233"),
