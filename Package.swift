...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "FCSDKiOS", url: "https://swift-sdk.s3.us-east-2.amazonaws.com/client_sdk/FCSDKiOS-4.2.1.xcframework.zip", checksum: "5d9e0f83482b9776cea732714305a436973eb22a30862192513bbbc072134277"),
